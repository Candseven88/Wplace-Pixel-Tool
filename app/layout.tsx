...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "wplace canvas art creator",
    
    // 技术关键词
    "collaborative pixel art",
    "Lanczos pixel scaling",
    "Floyd-Steinberg dithering",
    "pixel art algorithm",
    "privacy pixel converter",
    
    // 多语言关键词
    "wplace像素艺术工具",
    "wplace ピクセルアート",
    "wplace 픽셀 아트",
    "herramienta pixel wplace",
    "outil pixel wplace"
  ],
  openGraph: {
    type: "website",
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li><Link href="/tutorials" className="text-foreground/70 hover:text-foreground transition-colors">Tutorials</Link></li>
                  <li><Link href="/about" className="text-foreground/70 hover:text-foreground transition-colors">About Us</Link></li>
                  <li><Link href="/faq" className="text-foreground/70 hover:text-foreground transition-colors">FAQ</Link></li>
                </ul>
              </div>
