...
import { locales, localeNames, type Locale, getLocalizedPathname, getLocaleFromPathname } from '../i18n';
...
export default function LanguageSwitcher() {
  ...
  // Get current locale from pathname using the i18n utility function
